...
CGFloat const NKOPickerViewGradientViewHeight           = 26.f;
CGFloat const NKOPickerViewGradientTopMargin            = 55.f;
CGFloat const NKOPickerViewDefaultMargin                = 20.f;
CGFloat const NKOPickerViewBrightnessIndicatorWidth     = 16.f;
CGFloat const NKOPickerViewBrightnessIndicatorHeight    = 35.f;
...
- (void)setTintColor:(UIColor *)tintColor
{
    ...
    self.brightnessIndicator.backgroundColor = [UIColor clearColor];
    self.brightnessIndicator.tintColor = tintColor;
...
- (void)_updateBrightnessPosition
{
    ...
    brightnessPosition.x = currentBrightness*self.gradientView.frame.size.width + self.gradientView.frame.origin.x;
...
{
	currentBrightness = (position.x - self.gradientView.frame.origin.x)/self.gradientView.frame.size.width;
...
- (NKOBrightnessView*)gradientView
{
    if (self->_gradientView == nil){
        ...
        self->_gradientView.layer.borderWidth = 0.5f;
...
- (UIImageView*)hueSatImage
{
    if (self->_hueSatImage == nil){
        ...
        self->_hueSatImage.layer.borderWidth = 0.5f;
...
{
    if ( self->_brightnessIndicator == nil ) {
        self->_brightnessIndicator = [[NKOTriangularIndicatorView alloc] initWithFrame:CGRectMake(
                                                                                    CGRectGetWidth(self.gradientView.frame)*0.5f,
                                                                                    CGRectGetMinY(self.gradientView.frame)-4,
                                                                                    NKOPickerViewBrightnessIndicatorWidth,
                                                                                    NKOPickerViewBrightnessIndicatorHeight)];
    }
